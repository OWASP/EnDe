...
#?
#? VERSION
#?      @(#) EnDeHTTP.js 3.4 12/11/23 21:51:40
#?
#? AUTHOR
...
EnDe.HTTP   = new function() {
  this.SID      = '3.4';
  this.sid      = function() { return('@(#) EnDeHTTP.js 3.4 12/11/23 21:51:40 EnDe.HTTP'); };
...
//src.replace(/(%)([0-9a-fA-F]{2})/g,  function(b,c,d){return c + c + d + d; });
  ...
  //#? return end of string starting at position idx until next occourance of character found at idx
	/*
  ...
  //#? return end of string starting at position idx until next occourance proper closing bracket
	/*
