...
#
#? VERSION
#?      @(#) EnDeREMap.js 3.8 12/04/11 23:46:06
#?
#? AUTHOR
...
var EnDeREMap = new function() { this.SID = '3.8'; } // dummy definition for EnDe.SIDs
...
// folgendes < aendern, da es fuer lookbehind gebraucht wird.
		...
		':Perl'     : [K,K,K,h,h,O,K,K,K,K,K,K,K,K,K,K,K], // perl can mimick named capture with $^N
