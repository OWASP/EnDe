...
//ah#08sep08# var debug_w;
//ah#08sep08# function debug (arr, name)
//ah#08sep08# {
//ah#08sep08#     if (!debug_w) 
//ah#08sep08#     {
//ah#08sep08#         var width = 600;
//ah#08sep08#         var height = 600;
//ah#08sep08#         var x = (screen.width/2-width/2);
//ah#08sep08#         var y = (screen.height/2-height/2);
//ah#08sep08#         debug_w = window.open('', '', 'scrollbars=yes,resizable=yes,width='+width+',height='+height+',screenX='+(x)+',screenY='+y+',left='+x+',top='+y);
//ah#08sep08#         debug_w.document.open();
//ah#08sep08#         debug_w.document.write('<html><head><style>body{margin: 1em;padding: 0;font-family: courier new; font-size: 12px;}h1,h2{margin: 0.2em 0;}</style></head><body><h1>Debug</h1></body></html>');
//ah#08sep08#         debug_w.document.close();
//ah#08sep08#     }
//ah#08sep08#     var ret = '';
//ah#08sep08#     if ('undefined' !== typeof name && name.length) {
//ah#08sep08#         ret = '<h2>'+name+'</h2>'+"\n";
//ah#08sep08#     }
//ah#08sep08#     if ('object' === typeof arr) {
//ah#08sep08#         for (var i = 0; i < arr.length; i++) {
//ah#08sep08#             ret += '['+i+'] => '+arr[i]+"\n";
//ah#08sep08#         }
//ah#08sep08#     } else if ('string' == typeof arr) {
//ah#08sep08#         ret += arr;
//ah#08sep08#     } else {
//ah#08sep08#         try { ret += arr.toString(); } catch (e) {}
//ah#08sep08#         ret += ' ('+typeof arr+')';
//ah#08sep08#     }
//ah#08sep08#     debug_w.document.body.innerHTML += '<pre>'+ret+'</pre>';
//ah#08sep08# }
