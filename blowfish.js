...
*/
/*
 from: http://github.com/drench/blowfish.js/blob/5d8d9a5d782c88691363025f4050dd827163e6dc/blowfish.js
 date: 06-jun-10
*/
...
#?
#? DESCRIPTION
#?      This file is a copy from http://github.com/drench/blowfish.js/
...
#?      EnDe.Blowfish.decrypt("text for the key", "text to decrypt");
#?      // or
#?      EnDe.Blowfish.EN.blowfish("text for the key", "text to encrypt");
#?      EnDe.Blowfish.DE.blowfish("text for the key", "text to decrypt");
#?      // or
#?      var blowfish = new EnDe.Blowfish("text for the key");
