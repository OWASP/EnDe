 ...
 *
 * Several functions taken, as noted, from Paul Johnston
 */
...
#?          2. all following references prefixed with  EnDe.SHA5.
#?              hexCase, charSize
#?          3. some missing semicolons added (for packer)
 ...
 */
this.charSize = 8; /* Number of Bits Per character (8 for ASCII, 16 for Unicode)	  */
...
function returnSHA2(hashArray, variant)
{
	...
	return 0; //#ah#  fallback, never reached but keeps lint quiet
};
